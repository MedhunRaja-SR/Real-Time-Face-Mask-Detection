...
IMAGE_DIR = "C:/Users/Admin/PycharmProjects/pythonProject/various_mask"
...
def cli():
    ...
    if not os.path.exists(args.pic_path):
        print('Picture {pic_path} not exists.')
        sys.exit(1)
...
def create_mask(image_path):
    pic_path = image_path
    mask_path = r"C:\Users\Admin\PycharmProjects\pythonProject\various_mask\blue-mask.png"
    show = False
    model = "hog"
...
folder_path = r"C:\Users\Admin\PycharmProjects\pythonProject\mask_dataset"
